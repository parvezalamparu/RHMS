            ...
            <tr>
              {headers.map((header) => (
                <th
                  ...
                  onClick={() =>
                    header.key !== "sn" && handleSort(header.key as keyof PurchaseItem)
                  }
                >
                  {header.label}{" "}
                  {header.key !== "sn" && (
          ...
          <tbody>
            ...
            {paginatedItems.map((item, index) => (
              ...
              >
                ...
                <td className="px-4 py-2 border border-gray-300">{item.purchaseId}</td>
                ...
                <td className="px-4 py-2 border border-gray-300 min-w-[10rem]">{item.purchaseBy}</td>
